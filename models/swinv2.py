...
class SwinV2(nn.Module):
    ...
    def __init__(self, num_classes: int, freeze: bool = True) -> nn.Module:
        """
        Args:
        ...
        self.swin = timm.create_model('swinv2_base_window16_256.ms_in1k', pretrained=True, num_classes=num_classes)
